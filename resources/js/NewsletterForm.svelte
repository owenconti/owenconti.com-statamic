...
{:else}
  ...
  <form class="flex justify-between" on:submit|preventDefault="{handleSubmit}">
    ...
    <input type="email" required name="email" placeholder="Email" class="flex-1 w-0 bg-white border-r-0 rounded-r-none dark:bg-brand-dark input" />
    <button type="submit" class="p-2 rounded-l-none accent-button whitespace-nowrap">Sign Up</button>
  </form>
{/if}
