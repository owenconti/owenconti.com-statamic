...
<meta property="og:image" content="https://snaps-proxy.owenconti.workers.dev?w=1200&h=632&dpi=2&url=https://owenconti.com/og-image-generator/?data={{ base64_encode(json_encode(['title' => $title ?? 'Owen Conti', 'excerpt' => $excerpt ?? ''])) }}">
<meta property="twitter:image" content="https://snaps-proxy.owenconti.workers.dev?w=1200&h=632&dpi=2&url=https://owenconti.com/og-image-generator/?data={{ base64_encode(json_encode(['title' => $title ?? 'Owen Conti', 'excerpt' => $excerpt ?? ''])) }}">
